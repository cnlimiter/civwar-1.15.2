...
package cn.evolvefield.civwar.item;
...
import cn.evolvefield.civwar.gui.CivBookGuiGui;
import cn.evolvefield.civwar.itemgroup.CivWarCoreItemGroup;
import cn.evolvefield.civwar.CivwarModElements;

@CivwarModElements.ModElement.Tag
public class CivBookItem extends CivwarModElements.ModElement {
	@ObjectHolder("civwar:civ_book")
	public static final Item block = null;
	public CivBookItem(CivwarModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(CivWarCoreItemGroup.tab).maxStackSize(1));
			setRegistryName("civ_book");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u6218\u4E89\u4E0E\u6587\u660E\u6307\u5357\u624B\u518C"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Civ Book");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new CivBookGuiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
